DROP TABLE IF EXISTS japp_product;
CREATE TABLE lc_product (
  ...
  max_invest decimal(16,2) NOT NULL DEFAULT 0.00 COMMENT '最大投资金额',
  single_max_invest decimal(16,2) NOT NULL DEFAULT 0.00 COMMENT '单人最大投资金额',
