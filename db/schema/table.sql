...
CREATE TABLE lc_product (
  ...
  profit decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT '标准收益率',
  ext_profit decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT '扩展收益率',
  min_invest decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT '最小起投金额',
  max_invest decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT '最大投资金额',
  single_max_invest decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT '单人最大投资金额',
  default_exprie_process_mode int(3) NOT NULL COMMENT ' 默认到期处理方式：0-不支持续投，1-本金续投，2-本息续投',
