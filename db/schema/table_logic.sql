...
CREATE TABLE u_order (
  ...
  period int(11) NOT NULL DEFAULT '0' COMMENT '冗余字段,投资期限',
  profit decimal(10,4) NOT NULL DEFAULT '0.0000' COMMENT '冗余字段,年化收益率',
  ext_profit decimal(10,4) DEFAULT '0.0000' COMMENT '扩展收益率',
  invest_mode int(3) NOT NULL COMMENT '投资方式：0-不支持续投，1-到期退出，2-本金续投，3-本息续投',
  spend_amount decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '投资金额',
  pay_amount decimal(10,2) DEFAULT NULL COMMENT '冗余字段，实际支付金额',
  discount_amount decimal(10,2) DEFAULT '0.00' COMMENT '优惠金额',
  discount_way int(2) NOT NULL DEFAULT '0' COMMENT '优惠方式：0-无优惠，1-本金券',
  expcted_earning decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '预期收益',
  ...
  channel_code int(20) NOT NULL DEFAULT '10' COMMENT '渠道1-PC；2-APP；3-M站；4-微信',
  parent_order_no varchar(50) NOT NULL COMMENT '父订单号(大礼包订单), 无父订单则是0',
  zp_flag int(2) NOT NULL DEFAULT '0' COMMENT '债匹标志 1 已债匹 0 未债匹' ,
  is_enable int(1) NOT NULL DEFAULT '0' COMMENT '0 无效 1有效',
  order_status int(2) NOT NULL DEFAULT '2' COMMENT '订单状态：0-未支付，1-持有中，2-已退出',
  create_time datetime NOT NULL COMMENT '记录创建时间',
  update_time datetime NOT NULL COMMENT '记录更新时间',
  pay_mode int(2) NOT NULL DEFAULT 0 COMMENT '冗余字段，支付方式 FY 1 富友支付 LL 2 连连支付 WZF3 微支付 CFT 5 财付通',
  attr text COMMENT '用户属性',
  PRIMARY KEY (id),
