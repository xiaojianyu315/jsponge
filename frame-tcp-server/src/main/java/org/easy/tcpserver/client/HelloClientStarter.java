...
import org.easy.common.constant.AppConstants;
...
public class HelloClientStarter {
    //服务器节点
    public static Node serverNode = new Node("127.0.0.1", AppConstants.PORT);
    ...
    private static void send() throws Exception {
        ...
        for(int i=0;i<10000;i++){
            packet.setBody((i+"").getBytes(HelloPacket.CHARSET));
