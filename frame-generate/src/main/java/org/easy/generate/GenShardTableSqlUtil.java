    ...
    public static void main(String[] args) {
        ...
        for (String table : tables) {
            ...
            for (int i = 0; i < db_count; i++) {
                sql.append("USE " + db_prefix + StringUtil.padRight(String.valueOf(i),2,'0') + ";\n");
                ...
                for (int j = tableStartIndex; j <= tableEndIndex; j++) {
                    tableTemp = table.replace(tableName, tableName + "_" + (StringUtil.padRight(String.valueOf(j),3,'0')));
